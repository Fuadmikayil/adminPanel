    ...
    <div className="w-full bg-white rounded-xl flex flex-col">
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-gray-400">
          <thead>
            <tr className="grid grid-cols-5 gap-8 p-4 items-center text-center border-b border-gray-200">
          ...
          <tbody>
            <tr className="grid grid-cols-5 gap-8 p-2 items-center text-center border-b border-gray-200">
